...
{cat:'skin',     name:'ذا أورديناري هيالورونيك أسيد 2% + بي 5', brand:'The Ordinary', art:'drops',   img:'images/products/the ordinary Hyaluronic Acid 2% + B5 (with Ceramides).webp', price:520, old:null, desc:'سيروم مرطب مكثف بحمض الهيالورونيك متعدد الأوزان الجزيئية والسيراميد لترطيب عميق وطويل الأمد.'},
{cat:'skin',     name:'ذا أورديناري نياسينامايد 10% + زنك 1%',  brand:'The Ordinary', art:'drops',   img:'images/products/the ordinary niacinamide + zinc.webp', price:480, old:null, desc:'سيروم مركز لتقليل ظهور المسام الواسعة وحب الشباب وتنظيم إفراز الدهون وتوحيد لون البشرة.'},
{cat:'skin',     name:'ذا أورديناري ساليسيليك أسيد 2%',     brand:'The Ordinary', art:'drops',   img:'images/products/the ordinary Salicylic Acid 2% Solution.webp', price:420, old:null, desc:'محلول تقشير لطيف بحمض الساليسيليك 2% لتنظيف المسام بعمق وتقليل الرؤوس السوداء.'},
